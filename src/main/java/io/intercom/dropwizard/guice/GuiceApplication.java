...
import io.intercom.dropwizard.module.MetricRegistryModule;


/**
 * Supports Guice in Dropwizard. <p>
 *
 * To use it, create a subclass and provide a list of modules you want to use with the {@link
 * #addModules} method.  <p>
 *
 * Packages supplied in the constructor will be scanned for Resources, Tasks, Providers,
 ...
 * method. <p>
 *
 * GuiceApplication also makes {@link com.codahale.metrics.MetricRegistry} available for injection.
 * <p>
 */
abstract public class GuiceApplication<T extends Configuration> extends Application<T> {
    ...
    /**
     * When the application runs, this is called after the {@link Bundle}s are run.<p>
     *
     * You generally don't want to override this but if you do, make sure to call up into super to
    ...
    /**
     * Supply a list of modules to be used by Guice.<p>
     *
    ...
    private void registerWithInjector(
        T configuration, Environment environment, Injector injector
    ) throws Exception {
